 ...
 */
package it.polimi.xtext.tosca4cloudifydsl.ide.contentassist.antlr;

import com.google.inject.Inject;
import it.polimi.xtext.tosca4cloudifydsl.ide.contentassist.antlr.internal.InternalDslParser;
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPropertyAccess().getGroup_9(), "rule__Property__Group_9__0");
					put(grammarAccess.getPropertyAccess().getGroup_10(), "rule__Property__Group_10__0");
					...
					put(grammarAccess.getOutputAccess().getParameter_nameAssignment_2(), "rule__Output__Parameter_nameAssignment_2");
					put(grammarAccess.getOutputAccess().getTypeAssignment_4_1(), "rule__Output__TypeAssignment_4_1");
					put(grammarAccess.getOutputAccess().getDescriptionAssignment_5_1(), "rule__Output__DescriptionAssignment_5_1");
					put(grammarAccess.getOutputAccess().getValueAssignment_6_1(), "rule__Output__ValueAssignment_6_1");
					put(grammarAccess.getOutputAccess().getRequiredAssignment_7_1(), "rule__Output__RequiredAssignment_7_1");
					put(grammarAccess.getOutputAccess().getDefaultAssignment_8_1(), "rule__Output__DefaultAssignment_8_1");
					put(grammarAccess.getOutputAccess().getStatusAssignment_9_1(), "rule__Output__StatusAssignment_9_1");
					...
					put(grammarAccess.getNode_templateAccess().getNodeTemplate_hasInstancesAssignment_11_1(), "rule__Node_template__NodeTemplate_hasInstancesAssignment_11_1");
					...
					put(grammarAccess.getPropertyAccess().getParameter_nameAssignment_2(), "rule__Property__Parameter_nameAssignment_2");
					put(grammarAccess.getPropertyAccess().getTypeAssignment_4_1(), "rule__Property__TypeAssignment_4_1");
					put(grammarAccess.getPropertyAccess().getDescriptionAssignment_5_1(), "rule__Property__DescriptionAssignment_5_1");
					put(grammarAccess.getPropertyAccess().getValueAssignment_6_1(), "rule__Property__ValueAssignment_6_1");
					put(grammarAccess.getPropertyAccess().getRequiredAssignment_7_1(), "rule__Property__RequiredAssignment_7_1");
					put(grammarAccess.getPropertyAccess().getDefaultAssignment_8_1(), "rule__Property__DefaultAssignment_8_1");
					put(grammarAccess.getPropertyAccess().getStatusAssignment_9_1(), "rule__Property__StatusAssignment_9_1");
					put(grammarAccess.getPropertyAccess().getProperty_nameAssignment_10_1(), "rule__Property__Property_nameAssignment_10_1");
					...
					put(grammarAccess.getInstanceAccess().getParameter_nameAssignment_2(), "rule__Instance__Parameter_nameAssignment_2");
					put(grammarAccess.getInstanceAccess().getTypeAssignment_4_1(), "rule__Instance__TypeAssignment_4_1");
					put(grammarAccess.getInstanceAccess().getDescriptionAssignment_5_1(), "rule__Instance__DescriptionAssignment_5_1");
					put(grammarAccess.getInstanceAccess().getValueAssignment_6_1(), "rule__Instance__ValueAssignment_6_1");
					put(grammarAccess.getInstanceAccess().getRequiredAssignment_7_1(), "rule__Instance__RequiredAssignment_7_1");
					put(grammarAccess.getInstanceAccess().getDefaultAssignment_8_1(), "rule__Instance__DefaultAssignment_8_1");
					put(grammarAccess.getInstanceAccess().getStatusAssignment_9_1(), "rule__Instance__StatusAssignment_9_1");
