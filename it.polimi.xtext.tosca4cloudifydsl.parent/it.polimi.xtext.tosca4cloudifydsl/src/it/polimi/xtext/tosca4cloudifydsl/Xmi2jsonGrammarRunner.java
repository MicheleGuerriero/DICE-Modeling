...
public static void main(String[] args) throws IOException {
	...
	public static void runme(String InputModelPath, String OutputModelPath  ){
	 // Register Epackage of modeling project otherwise, you will see: make sure that Epackage is registered
		 ...
		 EPackage.Registry.INSTANCE.put("http://tosca4cloudify/1.0",Tosca4cloudifyPackage.eINSTANCE);
		...
		Resource textualModel_resource =(Resource)xtext_resourceSet.createResource(URI.createURI(OutputModelPath+".dsl"));
		...
		try {
			Process p = Runtime.getRuntime().exec("python ./src/org/xtext/example/mydsl/Json2YAMLConverter.py ./"+OutputModelPath+".dsl"+  " ./"+OutputModelPath+".yaml");
