 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.Operation#getOperation_name <em>Operation name</em>}</li>
 *   <li>{@link tosca4cloudify.Operation#getDescription <em>Description</em>}</li>
 *   <li>{@link tosca4cloudify.Operation#getOperation_hasInput <em>Operation has Input</em>}</li>
 *   <li>{@link tosca4cloudify.Operation#getScript <em>Script</em>}</li>
 *   <li>{@link tosca4cloudify.Operation#getExecutor <em>Executor</em>}</li>
 * </ul>
 *
 * @see tosca4cloudify.Tosca4cloudifyPackage#getOperation()
 * @model
 * @generated
 */
