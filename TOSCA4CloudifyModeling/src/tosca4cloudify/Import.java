 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.Import#getImport_name <em>Import name</em>}</li>
 *   <li>{@link tosca4cloudify.Import#getFile <em>File</em>}</li>
 *   <li>{@link tosca4cloudify.Import#getRepository <em>Repository</em>}</li>
 *   <li>{@link tosca4cloudify.Import#getNamespace_uri <em>Namespace uri</em>}</li>
 *   <li>{@link tosca4cloudify.Import#getNamespace_prefix <em>Namespace prefix</em>}</li>
 * </ul>
 *
 * @see tosca4cloudify.Tosca4cloudifyPackage#getImport()
 * @model
 * @generated
 */
