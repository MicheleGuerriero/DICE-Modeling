 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.impl.InterfaceImpl#getInterface_name <em>Interface name</em>}</li>
 *   <li>{@link tosca4cloudify.impl.InterfaceImpl#getHasOperation <em>Has Operation</em>}</li>
 *   <li>{@link tosca4cloudify.impl.InterfaceImpl#getInterface_hasInput <em>Interface has Input</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceImpl extends MinimalEObjectImpl.Container implements Interface {
    ...
    protected EClass eStaticClass() {
        return Tosca4cloudifyPackage.Literals.INTERFACE;
    }
    ...
    public void setInterface_name(String newInterface_name) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.INTERFACE__INTERFACE_NAME, oldInterface_name, interface_name));
    }
    ...
    public EList<Operation> getHasOperation() {
        if (hasOperation == null) {
            hasOperation = new EObjectContainmentEList<Operation>(Operation.class, this, Tosca4cloudifyPackage.INTERFACE__HAS_OPERATION);
        }
        return hasOperation;
    }
    ...
    public EList<Input> getInterface_hasInput() {
        if (interface_hasInput == null) {
            interface_hasInput = new EObjectContainmentEList<Input>(Input.class, this, Tosca4cloudifyPackage.INTERFACE__INTERFACE_HAS_INPUT);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Tosca4cloudifyPackage.INTERFACE__HAS_OPERATION:
                return ((InternalEList<?>)getHasOperation()).basicRemove(otherEnd, msgs);
            case Tosca4cloudifyPackage.INTERFACE__INTERFACE_HAS_INPUT:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Tosca4cloudifyPackage.INTERFACE__INTERFACE_NAME:
