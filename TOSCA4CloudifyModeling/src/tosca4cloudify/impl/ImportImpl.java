 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.impl.ImportImpl#getImport_name <em>Import name</em>}</li>
 *   <li>{@link tosca4cloudify.impl.ImportImpl#getFile <em>File</em>}</li>
 *   <li>{@link tosca4cloudify.impl.ImportImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link tosca4cloudify.impl.ImportImpl#getNamespace_uri <em>Namespace uri</em>}</li>
 *   <li>{@link tosca4cloudify.impl.ImportImpl#getNamespace_prefix <em>Namespace prefix</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImportImpl extends MinimalEObjectImpl.Container implements Import {
    ...
    protected EClass eStaticClass() {
        return Tosca4cloudifyPackage.Literals.IMPORT;
    }
    ...
    public void setImport_name(String newImport_name) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.IMPORT__IMPORT_NAME, oldImport_name, import_name));
    }
    ...
    public void setFile(String newFile) {
        ...
        file = newFile;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.IMPORT__FILE, oldFile, file));
    }
    ...
    public void setRepository(String newRepository) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.IMPORT__REPOSITORY, oldRepository, repository));
    }
    ...
    public void setNamespace_uri(String newNamespace_uri) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.IMPORT__NAMESPACE_URI, oldNamespace_uri, namespace_uri));
    }
    ...
    public void setNamespace_prefix(String newNamespace_prefix) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.IMPORT__NAMESPACE_PREFIX, oldNamespace_prefix, namespace_prefix));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Tosca4cloudifyPackage.IMPORT__IMPORT_NAME:
                return getImport_name();
            case Tosca4cloudifyPackage.IMPORT__FILE:
                return getFile();
            case Tosca4cloudifyPackage.IMPORT__REPOSITORY:
                return getRepository();
            case Tosca4cloudifyPackage.IMPORT__NAMESPACE_URI:
                return getNamespace_uri();
            case Tosca4cloudifyPackage.IMPORT__NAMESPACE_PREFIX:
