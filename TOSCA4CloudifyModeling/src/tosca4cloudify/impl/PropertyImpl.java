 ...
 *   <li>{@link tosca4cloudify.impl.PropertyImpl#getProperty_hasParameters <em>Property has Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
	...
	public EList<Parameters> getProperty_hasParameters() {
		if (property_hasParameters == null) {
			property_hasParameters = new EObjectContainmentEList<Parameters>(Parameters.class, this, Tosca4cloudifyPackage.PROPERTY__PROPERTY_HAS_PARAMETERS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Tosca4cloudifyPackage.PROPERTY__PROPERTY_HAS_PARAMETERS:
