 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.impl.RequirementImpl#getRequirement_name <em>Requirement name</em>}</li>
 *   <li>{@link tosca4cloudify.impl.RequirementImpl#getNode <em>Node</em>}</li>
 *   <li>{@link tosca4cloudify.impl.RequirementImpl#getCapability_Type_name <em>Capability Type name</em>}</li>
 *   <li>{@link tosca4cloudify.impl.RequirementImpl#getOccurances <em>Occurances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequirementImpl extends MinimalEObjectImpl.Container implements Requirement {
    ...
    protected EClass eStaticClass() {
        return Tosca4cloudifyPackage.Literals.REQUIREMENT;
    }
    ...
    public void setRequirement_name(String newRequirement_name) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.REQUIREMENT__REQUIREMENT_NAME, oldRequirement_name, requirement_name));
    }
    ...
    public void setNode(String newNode) {
        ...
        node = newNode;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.REQUIREMENT__NODE, oldNode, node));
    }
    ...
    public void setCapability_Type_name(String newCapability_Type_name) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.REQUIREMENT__CAPABILITY_TYPE_NAME, oldCapability_Type_name, capability_Type_name));
    }
    ...
    public EList<String> getOccurances() {
        if (occurances == null) {
            occurances = new EDataTypeUniqueEList<String>(String.class, this, Tosca4cloudifyPackage.REQUIREMENT__OCCURANCES);
        }
        return occurances;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Tosca4cloudifyPackage.REQUIREMENT__REQUIREMENT_NAME:
                return getRequirement_name();
            case Tosca4cloudifyPackage.REQUIREMENT__NODE:
                return getNode();
            case Tosca4cloudifyPackage.REQUIREMENT__CAPABILITY_TYPE_NAME:
                return getCapability_Type_name();
            case Tosca4cloudifyPackage.REQUIREMENT__OCCURANCES:
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case Tosca4cloudifyPackage.REQUIREMENT___EOPERATION0:
                EOperation0();
                return null;
        }
