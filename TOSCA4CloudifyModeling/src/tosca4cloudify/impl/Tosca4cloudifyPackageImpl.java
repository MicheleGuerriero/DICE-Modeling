...
import tosca4cloudify.Tosca4cloudifyFactory;
 ...
 * @generated
 */
public class Tosca4cloudifyPackageImpl extends EPackageImpl implements Tosca4cloudifyPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @see tosca4cloudify.Tosca4cloudifyPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private Tosca4cloudifyPackageImpl() {
        super(eNS_URI, Tosca4cloudifyFactory.eINSTANCE);
    }
     ...
     * 
     * <p>This method is used to initialize {@link Tosca4cloudifyPackage#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static Tosca4cloudifyPackage init() {
        if (isInited) return (Tosca4cloudifyPackage)EPackage.Registry.INSTANCE.getEPackage(Tosca4cloudifyPackage.eNS_URI);

        // Obtain or create and register package
        Tosca4cloudifyPackageImpl theTosca4cloudifyPackage = (Tosca4cloudifyPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Tosca4cloudifyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Tosca4cloudifyPackageImpl());

        isInited = true;

        // Create package meta-data objects
        theTosca4cloudifyPackage.createPackageContents();

        // Initialize created meta-data
        theTosca4cloudifyPackage.initializePackageContents();

        // Mark meta-data to indicate it can't be changed
        theTosca4cloudifyPackage.freeze();

  
        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(Tosca4cloudifyPackage.eNS_URI, theTosca4cloudifyPackage);
        return theTosca4cloudifyPackage;
    }
     ...
     * @generated
     */
    public Tosca4cloudifyFactory getTosca4cloudifyFactory() {
        return (Tosca4cloudifyFactory)getEFactoryInstance();
    }
    ...
    public void initializePackageContents() {
        ...
        propertyEClass.getESuperTypes().add(this.getParameter());
