 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.impl.ParametersImpl#getParemeters_hasParameter <em>Paremeters has Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametersImpl extends MinimalEObjectImpl.Container implements Parameters {
	...
	protected EClass eStaticClass() {
		return Tosca4cloudifyPackage.Literals.PARAMETERS;
	}
	...
	public EList<Parameter> getParemeters_hasParameter() {
		if (paremeters_hasParameter == null) {
			paremeters_hasParameter = new EObjectContainmentEList<Parameter>(Parameter.class, this, Tosca4cloudifyPackage.PARAMETERS__PAREMETERS_HAS_PARAMETER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Tosca4cloudifyPackage.PARAMETERS__PAREMETERS_HAS_PARAMETER:
