 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getNode_template_name <em>Node template name</em>}</li>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getType <em>Type</em>}</li>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getNodeTemplate_hasInterface <em>Node Template has Interface</em>}</li>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getNodeTemplate_hasProperty <em>Node Template has Property</em>}</li>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getNodeTemplate_hasAttribute <em>Node Template has Attribute</em>}</li>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getNodeTemplate_hasRequirement <em>Node Template has Requirement</em>}</li>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getNodeTemplate_hasRelationship <em>Node Template has Relationship</em>}</li>
 *   <li>{@link tosca4cloudify.impl.Node_templateImpl#getNodeTemplate_hasInstances <em>Node Template has Instances</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Node_templateImpl extends MinimalEObjectImpl.Container implements Node_template {
	...
	protected EClass eStaticClass() {
		return Tosca4cloudifyPackage.Literals.NODE_TEMPLATE;
	}
	...
	public void setNode_template_name(String newNode_template_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_NAME, oldNode_template_name, node_template_name));
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.NODE_TEMPLATE__TYPE, oldType, type));
	}
	...
	public EList<Interface> getNodeTemplate_hasInterface() {
		if (nodeTemplate_hasInterface == null) {
			nodeTemplate_hasInterface = new EObjectContainmentEList<Interface>(Interface.class, this, Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_INTERFACE);
		}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.NODE_TEMPLATE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<Property> getNodeTemplate_hasProperty() {
		if (nodeTemplate_hasProperty == null) {
			nodeTemplate_hasProperty = new EObjectContainmentEList<Property>(Property.class, this, Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_PROPERTY);
		}
	...
	public EList<Attribute> getNodeTemplate_hasAttribute() {
		if (nodeTemplate_hasAttribute == null) {
			nodeTemplate_hasAttribute = new EObjectContainmentEList<Attribute>(Attribute.class, this, Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_ATTRIBUTE);
		}
	...
	public EList<Requirement> getNodeTemplate_hasRequirement() {
		if (nodeTemplate_hasRequirement == null) {
			nodeTemplate_hasRequirement = new EObjectContainmentEList<Requirement>(Requirement.class, this, Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_REQUIREMENT);
		}
	...
	public EList<Relationship> getNodeTemplate_hasRelationship() {
		if (nodeTemplate_hasRelationship == null) {
			nodeTemplate_hasRelationship = new EObjectContainmentEList<Relationship>(Relationship.class, this, Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_RELATIONSHIP);
		}
	...
	public NotificationChain basicSetNodeTemplate_hasInstances(instance newNodeTemplate_hasInstances, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_INSTANCES, oldNodeTemplate_hasInstances, newNodeTemplate_hasInstances);
	...
	public void setNodeTemplate_hasInstances(instance newNodeTemplate_hasInstances) {
		if (newNodeTemplate_hasInstances != nodeTemplate_hasInstances) {
			...
			if (nodeTemplate_hasInstances != null)
				msgs = ((InternalEObject)nodeTemplate_hasInstances).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_INSTANCES, null, msgs);
			if (newNodeTemplate_hasInstances != null)
				msgs = ((InternalEObject)newNodeTemplate_hasInstances).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_INSTANCES, null, msgs);
			msgs = basicSetNodeTemplate_hasInstances(newNodeTemplate_hasInstances, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_INSTANCES, newNodeTemplate_hasInstances, newNodeTemplate_hasInstances));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_INTERFACE:
				return ((InternalEList<?>)getNodeTemplate_hasInterface()).basicRemove(otherEnd, msgs);
			case Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_PROPERTY:
				return ((InternalEList<?>)getNodeTemplate_hasProperty()).basicRemove(otherEnd, msgs);
			case Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_ATTRIBUTE:
				return ((InternalEList<?>)getNodeTemplate_hasAttribute()).basicRemove(otherEnd, msgs);
			case Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_REQUIREMENT:
				return ((InternalEList<?>)getNodeTemplate_hasRequirement()).basicRemove(otherEnd, msgs);
			case Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_RELATIONSHIP:
				return ((InternalEList<?>)getNodeTemplate_hasRelationship()).basicRemove(otherEnd, msgs);
			case Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_INSTANCES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_NAME:
				return getNode_template_name();
			case Tosca4cloudifyPackage.NODE_TEMPLATE__TYPE:
				return getType();
			case Tosca4cloudifyPackage.NODE_TEMPLATE__NODE_TEMPLATE_HAS_INTERFACE:
				return getNodeTemplate_hasInterface();
			case Tosca4cloudifyPackage.NODE_TEMPLATE__DESCRIPTION:
