 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.impl.instanceImpl#getDeploy <em>Deploy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class instanceImpl extends MinimalEObjectImpl.Container implements instance {
	...
	protected EClass eStaticClass() {
		return Tosca4cloudifyPackage.Literals.INSTANCE;
	}
	...
	public void setDeploy(int newDeploy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.INSTANCE__DEPLOY, oldDeploy, deploy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Tosca4cloudifyPackage.INSTANCE__DEPLOY:
				return getDeploy();
		}
