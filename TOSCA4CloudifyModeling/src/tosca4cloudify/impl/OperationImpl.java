 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.impl.OperationImpl#getOperation_name <em>Operation name</em>}</li>
 *   <li>{@link tosca4cloudify.impl.OperationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link tosca4cloudify.impl.OperationImpl#getOperation_hasInput <em>Operation has Input</em>}</li>
 *   <li>{@link tosca4cloudify.impl.OperationImpl#getScript <em>Script</em>}</li>
 *   <li>{@link tosca4cloudify.impl.OperationImpl#getExecutor <em>Executor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends MinimalEObjectImpl.Container implements Operation {
	...
	protected EClass eStaticClass() {
		return Tosca4cloudifyPackage.Literals.OPERATION;
	}
	...
	public void setOperation_name(String newOperation_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.OPERATION__OPERATION_NAME, oldOperation_name, operation_name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.OPERATION__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<Input> getOperation_hasInput() {
		if (operation_hasInput == null) {
			operation_hasInput = new EObjectContainmentEList<Input>(Input.class, this, Tosca4cloudifyPackage.OPERATION__OPERATION_HAS_INPUT);
		}
	...
	public void setScript(String newScript) {
		...
		script = newScript;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.OPERATION__SCRIPT, oldScript, script));
	}
	...
	public void setExecutor(String newExecutor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.OPERATION__EXECUTOR, oldExecutor, executor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Tosca4cloudifyPackage.OPERATION__OPERATION_HAS_INPUT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Tosca4cloudifyPackage.OPERATION__OPERATION_NAME:
				return getOperation_name();
			case Tosca4cloudifyPackage.OPERATION__DESCRIPTION:
				return getDescription();
			case Tosca4cloudifyPackage.OPERATION__OPERATION_HAS_INPUT:
				return getOperation_hasInput();
			case Tosca4cloudifyPackage.OPERATION__SCRIPT:
				return getScript();
			case Tosca4cloudifyPackage.OPERATION__EXECUTOR:
				return getExecutor();
		}
