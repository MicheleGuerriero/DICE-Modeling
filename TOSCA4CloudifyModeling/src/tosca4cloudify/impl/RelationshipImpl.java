 ...
 * </p>
 * <ul>
 *   <li>{@link tosca4cloudify.impl.RelationshipImpl#getType <em>Type</em>}</li>
 *   <li>{@link tosca4cloudify.impl.RelationshipImpl#getValidSource <em>Valid Source</em>}</li>
 *   <li>{@link tosca4cloudify.impl.RelationshipImpl#getValidTarget <em>Valid Target</em>}</li>
 *   <li>{@link tosca4cloudify.impl.RelationshipImpl#getRelation_haSourceInterface <em>Relation ha Source Interface</em>}</li>
 *   <li>{@link tosca4cloudify.impl.RelationshipImpl#getRelation_hasTargetInterface <em>Relation has Target Interface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipImpl extends MinimalEObjectImpl.Container implements Relationship {
    ...
    protected EClass eStaticClass() {
        return Tosca4cloudifyPackage.Literals.RELATIONSHIP;
    }
    ...
    public void setType(String newType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.RELATIONSHIP__TYPE, oldType, type));
    }
    ...
    public void setValidSource(String newValidSource) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.RELATIONSHIP__VALID_SOURCE, oldValidSource, validSource));
    }
    ...
    public void setValidTarget(String newValidTarget) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Tosca4cloudifyPackage.RELATIONSHIP__VALID_TARGET, oldValidTarget, validTarget));
    }
    ...
    public EList<Source_interface> getRelation_haSourceInterface() {
        if (relation_haSourceInterface == null) {
            relation_haSourceInterface = new EObjectContainmentEList<Source_interface>(Source_interface.class, this, Tosca4cloudifyPackage.RELATIONSHIP__RELATION_HA_SOURCE_INTERFACE);
        }
    ...
    public EList<Target_interface> getRelation_hasTargetInterface() {
        if (relation_hasTargetInterface == null) {
            relation_hasTargetInterface = new EObjectContainmentEList<Target_interface>(Target_interface.class, this, Tosca4cloudifyPackage.RELATIONSHIP__RELATION_HAS_TARGET_INTERFACE);
        }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case Tosca4cloudifyPackage.RELATIONSHIP__RELATION_HA_SOURCE_INTERFACE:
                return ((InternalEList<?>)getRelation_haSourceInterface()).basicRemove(otherEnd, msgs);
            case Tosca4cloudifyPackage.RELATIONSHIP__RELATION_HAS_TARGET_INTERFACE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case Tosca4cloudifyPackage.RELATIONSHIP__TYPE:
                return getType();
            case Tosca4cloudifyPackage.RELATIONSHIP__VALID_SOURCE:
                return getValidSource();
            case Tosca4cloudifyPackage.RELATIONSHIP__VALID_TARGET:
